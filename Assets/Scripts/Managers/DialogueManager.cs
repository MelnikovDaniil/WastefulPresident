...
public class DialogueManager : MonoBehaviour
{
    ...
    private Queue<Sentance> sentances;
    private List<(Emotion emotion, Sprite sprite)> emotions;
    ...
    public void DisplayNextSentance()
    {
        ...
        StopAllCoroutines();
        var sentance = sentances.Dequeue();
        icon.sprite = emotions.First(x => x.emotion == sentance.emotion).sprite;
        if (sentance.emotion == Emotion.Angry)
        {
